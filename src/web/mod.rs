...
use handlers::{
    activities::{authenticate_garmin, get_activity, get_activity_photos, get_activity_track, get_garmin_status, list_activities, merge_activities, sync_garmin_activities, trim_activity},
    apple::{claim_apple_export, commit_apple_export, fail_apple_export, list_apple_candidates, list_apple_sources, list_recent_apple_photos, renew_apple_export, retry_apple_source, review_apple_candidate},
...
fn router_with_application(
    ...
    Router::new()
        ...
        .route("/api/apple/recently-synchronized", get(list_recent_apple_photos))
        ...
        .route("/api/geo/name-policy", get(get_geo_name_policy))
        .route("/api/geo/normalize-names", post(start_geo_name_normalization))
        ...
        .route("/api/activities/garmin/status", get(get_garmin_status))
        .route("/api/activities/garmin/auth", post(authenticate_garmin))
        .route("/api/activities/garmin/sync", post(sync_garmin_activities))
